...
import com.github.zhongzichang.springiap.receipt.ReceiptVerifierImpl;
...
public class ReceiptVerifierTest {
  ...
  void verifyDeprecatedTransactionTest() throws IOException {
    ...
    ReceiptVerifyResult result = verifier.verify(content, null, true);
    assertNotNull(result);
    assertEquals(result.getStatus(), 21004);
  }
}
